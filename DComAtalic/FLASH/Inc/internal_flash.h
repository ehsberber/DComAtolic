#ifndef __INTERNAL_FLASH__
#define __INTERNAL_FLASH__
#include "main.h"
...
// SET which flash size must active 

#define _FLASH_SIZE_128_KB

#ifdef _FLASH_SIZE_64_KB
...
#define FLASH_USER_END_ADDR     (ADDR_FLASH_PAGE_53 + FLASH_PAGE_SIZE)   /* End @ of user Flash area */
